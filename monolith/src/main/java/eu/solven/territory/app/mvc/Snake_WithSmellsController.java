...
public class Snake_WithSmellsController extends AGameController<ISnakeWorldItem> {
	private static final Logger LOGGER = LoggerFactory.getLogger(Snake_WithSmellsController.class);
	...
	public Snake_WithSmellsController(EventBus eventBus) {
		super(eventBus);
